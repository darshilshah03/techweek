...
<div id="div5">
  ...
  <a href="https://navigare.herokuapp.com/registersingle.php"><button class="button" id="login">User Registration</button></a>
  
  <a href="https://navigare.herokuapp.com/event.html"><button class="button"  id="register">Event Registration</button></a>
