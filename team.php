<?php 
	...
	if(isset($_POST['memberid1'])){
		...
		if($row===false)
		{
			...
			$stmt = $pdo->prepare("UPDATE techweek.hackathon set id3 = :m3 where team_name = :nam AND id1 = :m1");
		...
		if($row!==false)
		{
			...
			$stmt = $pdo->prepare("UPDATE techweek.hackathon set id4 = :m4 where team_name = :nam AND id1 = :m1");
